        ...
        <footer className="bg-dark text-center text-white">
            <div className="container p-4 pb-0">
              <section className="mb-4">
                ...
                <a className="btn btn-outline-light btn-floating m-1" href="https://www.gmail.com" role="button"
                  ><i className="fab fa-google"></i></a>
                <a className="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/ani.saroian/" role="button"
                  ><i className="fab fa-instagram"></i></a>
                <a className="btn btn-outline-light btn-floating m-1" href="https://www.linkedin.com/in/ani-saroian-968949228/" role="button"
            ...
            <div className="text-center p-3" style={{
              ...
              © 2020 Copyright:
              <a href="https://tco.am/am" className="link"> TCO Team</a>
